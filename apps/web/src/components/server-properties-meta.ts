...
export const PROPERTY_DEFS: PropertyDef[] = [
  ...
  {
    key: "enable-status",
    label: "Respond to status pings",
    help: "Lets clients see the MOTD in the server list.",
    type: "boolean",
    default: true,
    group: "network",
  },
  {
    ...
    help: "Max packets/sec per client. 0 disables.",
    type: "number",
    min: 0,
    max: 1000000,
    default: 0,
  ...
  },
  {
    ...
    label: "Broadcast console messages to ops",
    type: "boolean",
    default: true,
    group: "security",
  },
  {
    ...
    help: "Don't reveal who is online in the server list.",
    type: "boolean",
    default: false,
    group: "security",
  },
  {
    ...
    help: "Disable for GDPR-compliance deployments.",
    type: "boolean",
    default: true,
    group: "security",
  },
  {
    ...
    label: "Text-filtering service config",
    help: "Usually blank — for Microsoft chat-moderation integration.",
    type: "string",
    monospace: true,
    group: "security",
  },
  ...
  },
  {
    ...
    label: "Use native transport (epoll)",
    help: "Faster networking on Linux hosts.",
    type: "boolean",
    default: true,
    group: "performance",
  },
  ...
  },
  {
    ...
    help: "Exposes JVM metrics via JMX. Off by default.",
    type: "boolean",
    default: false,
    group: "performance",
  },
  {
    ...
    help: "Server pauses itself if no players for N seconds. 0 disables.",
    type: "number",
    min: 0,
    max: 86400,
    default: 0,
  ...
  // ---- Resource pack (via server.properties) ----
  {
    key: "resource-pack",
  ...
  },
  {
    ...
    help: "Optional integrity hash for the pack.",
    type: "string",
    monospace: true,
    group: "gameplay",
  },
  ...
  },
  {
    ...
    label: "Initial enabled datapacks",
    help: "Comma-separated datapack IDs applied at world creation.",
    type: "string",
    monospace: true,
    default: "vanilla",
    group: "gameplay",
  },
  {
    ...
    label: "Initial disabled datapacks",
    type: "string",
    monospace: true,
    group: "gameplay",
  },

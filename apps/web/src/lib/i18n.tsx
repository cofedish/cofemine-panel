...
const en: Dict = {
  ...
  "server.tabs.chat": "Chat",
  "chat.title": "Server chat",
  "chat.empty": "Waiting for chat messages…",
  "chat.placeholder": "Say something to the server…",
  "chat.send": "Say",
  "chat.online": "Online ({n})",
  "chat.clear": "Clear",
  "server.tabs.map": "Map",
  ...
  "envForm.setCount": "{n} set",
  "envForm.clear": "clear",
  "envForm.customSection": "Custom variables",
  "envForm.customNone": "none",
  "envForm.customCount": "{n} defined",
  "envForm.valuePlaceholder": "value",
  ...
  "clientMods.mpServer.title": "Multiplayer server entry",
  "clientMods.mpServer.intro":
    "Public connect address baked into the client pack as a pre-populated multiplayer entry (servers.dat). Friends see your server in their server list the first time they launch the pack — no manual «Add Server» step.",
  "clientMods.mpServer.addressLabel": "Address (host or host:port)",
  "clientMods.mpServer.nameLabel": "Display name (blank = «{fallback}»)",
  "common.saved": "Saved.",
  "server.rename.title": "Rename server",
  "server.rename.body":
    "New name shown in the panel and used as the default display name inside the client .mrpack. Docker container name does NOT change.",
  "server.rename.button": "Rename",
  "server.rename.tooShort": "At least 2 characters",
  "server.rename.tooLong": "At most 80 characters",
  ...
  "clientMods.publicLink.listed": "Also list this pack in the public directory (/p/index.json). The directory publishes the link itself, so anyone who knows the panel URL can download the pack -- leave this off to keep the link shareable-only.",
...
const ru: Dict = {
  ...
  "server.tabs.chat": "Чат",
  "chat.title": "Чат сервера",
  "chat.empty": "Жду сообщений в чате…",
  "chat.placeholder": "Что-то сказать на сервер…",
  "chat.send": "Сказать",
  "chat.online": "Онлайн ({n})",
  "chat.clear": "Очистить",
  ...
  "envForm.setCount": "{n} задано",
  "envForm.clear": "очистить",
  "envForm.customSection": "Свои переменные",
  "envForm.customNone": "нет",
  "envForm.customCount": "{n} определено",
  "envForm.valuePlaceholder": "значение",
  ...
  "clientMods.mpServer.title": "Запись в multiplayer-меню",
  "clientMods.mpServer.intro":
    "Публичный адрес сервера, который зашьётся в клиентский пак как готовая запись в multiplayer-меню (servers.dat). Друзья увидят твой сервер в списке сразу при первом запуске сборки — без «Добавить сервер» вручную.",
  "clientMods.mpServer.addressLabel": "Адрес (host или host:port)",
  "clientMods.mpServer.nameLabel": "Отображаемое имя (пусто = «{fallback}»)",
  "common.saved": "Сохранено.",
  "server.rename.title": "Переименовать сервер",
  "server.rename.body":
    "Новое имя показывается в панели и используется по умолчанию в клиентской .mrpack. Имя Docker-контейнера НЕ меняется.",
  "server.rename.button": "Переименовать",
  "server.rename.tooShort": "Минимум 2 символа",
  "server.rename.tooLong": "Максимум 80 символов",
  ...
  "clientMods.publicLink.listed": "Показывать пакет в публичном каталоге (/p/index.json). Каталог публикует саму ссылку, поэтому скачать пакет сможет любой, кто знает адрес панели -- оставьте выключенным, чтобы ссылка работала только по прямой передаче.",
